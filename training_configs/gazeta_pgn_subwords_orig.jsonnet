...
local BPE_MODEL_PATH = "https://bpe-models.s3.eu-west-3.amazonaws.com/bpe_gazeta_orig_10k.model";
local READER = "gazeta";
local LOWERCASE = false;
local SOURCE_MAX_TOKENS = 600;
local TARGET_MAX_TOKENS = 150;
local VOCAB_SIZE = 10000;
local BATCH_SIZE = 16;
local EMBEDDING_DIM = 128;
local RNN_DIM = 256;
local RNN_NUM_LAYERS = 2;
local MAX_DECODING_STEPS = 150;
local BEAM_SIZE = 4;
local NUM_EPOCHS = 10;
local LR = 0.001;
local CUDA_DEVICE = 0;
